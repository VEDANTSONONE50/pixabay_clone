...
<button onClick={()=> fetchImageByCategory("buildings")} type="button" className="btn btn-outline-info mx-3">Buildings</button>
<button onClick={()=> fetchImageByCategory("warning")} type="button" className="btn btn-outline-warning mx-3">Warning</button>
